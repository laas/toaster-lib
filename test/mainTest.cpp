...
int main(int argc, char *argv[])
  ...
  areaCorners.push_back(corner1);
  areaCorners.push_back(corner2);
  areaCorners.push_back(corner3);
  areaCorners.push_back(corner4);
  ...
  if( bedroom.isPointInArea( convert3dTo2d(greg.getPosition()) ) );
}
