...
public:
	...
	boost::circular_buffer<long>::size_type size(){ return m_TimeBuffer.size(); }
	// Get the maximum number of elements stored in the TRBuffer.
	boost::circular_buffer<long>::size_type capacity(){ return m_TimeBuffer.capacity(); }
	boost::circular_buffer<long>::size_type max_size(){ return m_TimeBuffer.max_size(); }
	bool empty(){ return m_TimeBuffer.empty(); }
	bool full(){ return m_TimeBuffer.full(); }
